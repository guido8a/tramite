...
//        headersTitulo.add(new Paragraph("GAD DE LA PROVINCIA DE PICHINCHA", fontTituloGad));
        headersTitulo.add(new Paragraph("Trámites y Procesos", fontSubtituloGad));
    ...
    def crearEncabezado(PdfWriter writer, Document documento, String tituloReporte) {
        ...
        File layoutFolder = ApplicationHolder.application.parentContext.getResource("images/logo_reportes.png").file
...
//        File layoutFolder = grailsApplication.parentContext.getResource("images/logo_gadpp_reportes.png").file
        File layoutFolder = grailsApplication.parentContext.getResource("images/logo_reportes.png").file
        def absolutePath = layoutFolder.absolutePath
//        println "Absolute Path to Layout Folder: ${absolutePath}"
...
//        def x = -200
        ...
        def chunkPieDireccion = new Chunk("Calle 1 N17-45 y Calle 2  • Teléfonos troncal: (593-2) 2544477 • 25444553 • ", fontPiePagina)
        def chunkPieWeb = new Chunk("www.intitucion.com.ec", fontPiePaginaBold)
...
//        logo.scalePercent(15);
        ...
        Chunk chunkLogo = new Chunk(logo, -200, -10)  // posicion de l aimagen "logo" en "x=-200" y "y=-10"
//        Chunk chunkLogo = new Chunk(logo, x, -10);
        ...
        paragraphHeader.add(new Paragraph("Trámites y Procesos", fontSubtituloGad))
