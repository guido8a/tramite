...
<body>
<div class="vertical-container" style="margin-top: 0px;">
...
<div style="margin-top: 30px; min-height: 650px" class="vertical-container">
    ...
    <div class="linea"></div>
    <table class="table table-bordered table-hover table-condensed" width="1070px">
        <thead>
        <tr>
            <th class="alinear" style="width: 80px">Documento</th>
            <th class="alinear" style="width: 80px">Fecha Creación</th>
            <th class="alinear" style="width: 150px">De</th>
            <th class="alinear" style="width: 150px">Para</th>
            <th class="alinear" style="width: 280px">Asunto</th>
            <th class="alinear" style="width: 60px">Priori- dad</th>
            <th class="alinear" style="width: 110px">Envia</th>
            <th class="alinear" style="width: 80px">Fecha Envio</th>
            <th class="alinear" style="width: 80px">Fecha Recepción</th>
        </tr>
        </thead>
    </table>
...
<div><strong>Nota</strong>: Si existen muchos registros que coinciden con el criterio de búsqueda, se retorna como máximo 20 <span
        class="text-info" style="margin-left: 40px">Se ordena por tipo de documento y fecha</span>
</div>
